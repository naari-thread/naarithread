      ...
      <div className="flex flex-1 flex-col p-3.5 sm:p-4.5">
        ...
        <div className="mt-1.5 sm:mt-2">
          <Link href={productHref} aria-label={`Open ${product.name}`} className="inline-block">
            <h3 className="block line-clamp-2 max-h-[2.75rem] overflow-hidden font-display text-[1.1rem] font-medium leading-tight text-primary transition hover:text-primary/90 sm:min-h-[3.35rem] sm:max-h-none sm:text-[1.3rem] sm:leading-tight">
              {product.name}
            </h3>
          </Link>
